...
<table cellpadding="0" cellspacing="0" width="<?php echo $width?>">
	<tr class="header">
        <td rowspan="2" width="26" align="center"><img src="img/seen.png" alt="Просмотрено"></td>
		...
		?>
		<td rowspan="2" width="26" align="center"><img src="img/hide.png" alt="Скрыть из списка"></td>
	</tr>
	<tr class="header">
		<td>IMDB</td>
		<td>Кинопоиск</td>
